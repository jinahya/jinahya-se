...
public final class Unsafe {
     ...
     * <code>checkPropertiesAccess</code> method doesn't allow access to the
     * system properties.
     */
    @CallerSensitive
     ...
     * values obtained by {@link #arrayBaseOffset} and {@link
     ...
     * object, if any, else a memory address locating the variable statically
     *
     ...
     * target address maybe determined by consulting {@link
     * #addressSize}.
     *
     * @see #allocateMemory
     */
     ...
     * all value types. Dispose of this memory by calling {@link
     * #freeMemory}, or resize it with {@link #reallocateMemory}.
     *
     * @throws IllegalArgumentException if the size is negative or too large for
     * the native size_t type
     *
     ...
     * this memory by calling {@link #freeMemory}, or resize it with {@link
     ...
     * mode, as discussed in {@link #getInt(Object,long)}. When the object
     * reference is null, the offset supplies an absolute base address.
     *
     * <p>
     * The stores are in coherent (atomic) units of a size determined by the
     * address and length parameters. If the effective address and length are
     * all even modulo 8, the stores take place in 'long' units. If the
     * effective address and length are (resp.) even modulo 4 or 2, the stores
     ...
     * method may be null, in which case no action is taken.
     *
     * @see #allocateMemory
     */
     ...
     *     return null;
     * }
     * </pre></blockquote> @deprecated As of 1.4.1, use
     * {@link #staticFieldBase(Field)} to obtain the base pertaining to a
     * specific {@link Field}. This method works only for JVMs which store all
     * statics for a given class in one place.
     */
    @Deprecated
    public Object staticFieldBase(Class c) {
        Field[] fields = c.getDeclaredFields();
     ...
     * class can be accessed via methods like {@link #getInt(Object,
     * long)}. This value may be null. This value may refer to an object which
     * is a "cookie", not guaranteed to be a real Object, and it should not be
     * used in any way except as argument to the get and put routines in this
     * class.
     */
     ...
     * not work properly with accessors like {@link
     ...
     * ProtectionDomain) instead. This method will be removed in JDK 8.
     */
    @Deprecated
    @CallerSensitive
    public native Class defineClass(String name, byte[] b, int off, int len);
     ...
     * <ul>
     * <li>Integer, Long, Float, Double: the corresponding wrapper object type
     * from java.lang
     * <li>Utf8: a string (must have suitable syntax if used as signature or
     * name)
     * <li>Class: any java.lang.Class object
     * <li>String: any object (not just a java.lang.String)
     * <li>InterfaceMethodRef: (NYI) a method handle to invoke on that call
     * site's arguments
     * </ul>
     *
     ...
     * @params cpPatches where non-null entries exist, they replace
     * corresponding CP entries in data
     */
     ...
     * occurred, or the thread is interrupted, or, if not absolute and time is
     * not zero, the given time nanoseconds have elapsed, or if absolute, the
     * given deadline in milliseconds since Epoch has passed, or spuriously
