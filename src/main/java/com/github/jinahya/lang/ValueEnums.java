...
/**
 * A helper class for {@link ValueEnum}.
 *
...
public final class ValueEnums {
     ...
     */
    public static <E extends Enum<E> & ValueEnum<E, V>, V> V[] fieldValues(
        ...
        for (int i = 0; i < fieldValues.length; i++) {
            fieldValues[i] = enumConstants[i].value();
        }
        return fieldValues;
    }
     ...
     */
    public static <E extends Enum<E> & ValueEnum<E, V>, V, T extends Collection<? super V>> T fieldValues(
        ...
        for (final E enumConstant : enumType.getEnumConstants()) {
            fieldValues.add(enumConstant.value());
        }
        return fieldValues;
    }
     ...
     */
    public static <E extends Enum<E> & ValueEnum<E, V>, V> E fromFieldValue(
        ...
        for (final E enumConstant : enumType.getEnumConstants()) {
            final V enumConstantFieldValue = enumConstant.value();
