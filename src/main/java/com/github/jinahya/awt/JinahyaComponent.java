 ...
 */
public final class JinahyaComponent {


    public static enum AlignmentX implements FloatFieldEnum<AlignmentX> {
         ...
         */
        RIGHT_ALIGHNMENT(Component.RIGHT_ALIGNMENT); // 1.0f// 1.0f


        private AlignmentX(final float fieldValue) {
    ...
    public static enum AlignmentY implements FloatFieldEnum<AlignmentY> {
         ...
         */
        BOTTOM_ALIGHNMENT(Component.BOTTOM_ALIGNMENT); // 1.0f// 1.0f


        private AlignmentY(final float fieldValue) {
